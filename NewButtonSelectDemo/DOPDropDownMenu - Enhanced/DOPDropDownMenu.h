...
////返回最小的时间
//- (NSString *)menuTiem:(DOPDropDownMenu *)MinTimeReturn;
////返回最大时间
//- (NSString *)menuTime:(DOPDropDownMenu *)MaxTimeReturn;
...
- (void)minSelectAction:(DOPDropDownMenu *)menu;
- (void)maxSelectAction:(DOPDropDownMenu *)menu;
- (void)confirmSelectAction:(DOPDropDownMenu *)menu;
- (void)removeKeyBord;
...
@interface DOPDropDownMenu : UIView <UITableViewDataSource, UITableViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,CollectionFootViewControllerDataSource,CollectionFootViewControllerDelegate>
...
@property (nonatomic, strong) NSArray *menuTitle;           // menutitle的数组
@property (nonatomic, assign) BOOL isStarMessage;           // 是否有初始值传下来
@property (nonatomic, assign) BOOL isStarTime;// 是否有初始值传下来
@property (nonatomic, strong) CollectionFootViewController *cFootView;
